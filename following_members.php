				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="column-2">
							...
							<h2>Following Members<span class="line"><span></span></span></h2>
...
$row = mysql_fetch_array(mysql_query("SELECT following FROM jobs.employer WHERE email='".$_SESSION["employer"]."';"));
$following = $row["following"];

$following_array = str_split($following);
$ar_len = count($following_array);

preg_match_all('!\d+!', $following, $matches);
...
while ($ar_len != -1)
{
    ...
    $row_get_name = mysql_fetch_array(mysql_query("SELECT name FROM jobs.employee WHERE iduser='".$out[$ar_len]."';"));
    echo "<a href='display_employee.php?iduser=".$out[$ar_len]."' style='text-transform: uppercase'>".$row_get_name["name"]."</a><br />";
