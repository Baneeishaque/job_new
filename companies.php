...
<head>
		...
		ga('send', 'pageview');
                 ...
                 <script type="text/javascript">
                    ...
                    function alerts()
                    {
                        alert("Login To View Company Profile");
                    }
				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="column-2">
							...
							<h2>All Jobs<span class="line"><span></span></span></h2>
                                                             ...
                                                             $con=mysql_connect("localhost","root","root");
                                                                ...
                                                                if(!mysql_select_db("jobs",$con))
                                                                	die("No Database Selected");
                                                                      ...
                                                                      echo "<table>";  
                                                                $result = mysql_query("SELECT DISTINCT company_name,photo,email FROM jobs.employer;");
                                                                            while ($row = mysql_fetch_array($result))
                                                                            {
                                                                                ...
                                                                                //echo $type;
                                                                                if($_SESSION["login_user"] != null)
                                                                                    echo "<tr><td><a href='company_profile.php?company=".$row['email']."'>".$name."</a></td>";
                                                                                
                                                                                else
                                                                                    echo "<tr><td><a style='cursor: pointer; cursor: hand;' onclick='alerts();'>".$name."</a></td>";
                                                                                
                                                                                if($row['photo'] != null)
                                                                                    echo "<td><img src='photo/".$row[photo]."' width=100 height=50></td></tr>";
                                                                                else
                                                                                    echo "<tr>";
                                                                            }
                                                                      echo "</table>";
