...
<head>
    ...
    <!--<div class="mynav">
	  ...
	  if($_SESSION["employer"] != null)   
        ...
        echo"
        <form name='verify' action='employer_verification_action.php?email=".$em."' method='POST'>
        
            <label>Verification Code</label><input type='text' name='otp' class='formstxt'/>
            <br />
            <input type='submit' value='Verify' class='formsbtn'/>
            <br />
            </form>
            <form name='resend_email' action='employer_resend_email.php?email=".$em."' method='POST'>
            <input type='submit' value='Resend Email' class='formsbtn'/>
