		...
		<header class="header">
			...
			<nav class="men">
        			...
        			<div class="login">
      					...
      					echo "<form action='password_reset_action_employer.php?email=".$_GET["email"]."' method='post'>";
                                            
                                                ?><table>
                                                <tr><td><input type="password" placeholder="New Password" name="password"></td></tr>
					        
					        <tr><td><input type="submit" value="Login" class="formsbtn"></td></tr>
