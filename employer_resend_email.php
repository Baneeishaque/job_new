...
<head>
    ...
    <!--<div class="mynav">
	  ...
	  if($_SESSION["employer"] != null)   
        ...
        $result=null;
        $row=null;
        $result=mysql_query("SELECT otp,mail FROM jobs.employer where email='".$email."' ;");
        ...
        if($row==null)
        {
            ...
            $message = '
                    ...
                    <body>
                      ...
                      <a href="http://localhost/job_new/employer_verification_action.php?email='.$em.' & otp='.$ot.'">Activate Your Account</a>
                    Or Type <strong>'.$ot.'</strong>
                      
                      <a href="http://localhost/job_new/employer_verification.php?email='.$em.'">here</a>
...
if(!$mail->Send())
{
    echo "Mailer Error." . $mail->ErrorInfo;
        ...
        echo "<br />Or Go To Verification Page";
        echo "<a href=employer_verification.php?email=".md5($em)."><input type='button' class='formsbtn' value='Verify'></a>";
        }
        ?>
