...
$result=null;
$row=null;
$result=mysql_query("SELECT otp FROM jobs.employee WHERE email='".$em."' ;");
...
if($row==null)
{
        ...
        if($ot==$otp)
        {
            ...
            mysql_query("UPDATE `employee` SET status='verified' WHERE email='".$em."'");
				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="column-2">
							...
							<h2>Verification <span class="line"><span></span></span></h2>
