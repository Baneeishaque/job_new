			...
			<section class="hero set-background" data-background="img/bg-contacts2.jpg">
				...
				<div class="hero-parallax">
					...
					<div class="hero-text">
                                            ...
                                            <h1>Jobs&nbsp;<span>By Location</span></h1>
                        <br /><br /><br /><br /><br /><br />
				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="column-2">
							...
							<h2>Locations <span class="line"><span></span></span></h2>
							...
							<div class="column-1">
                                            ...
                                            if(!mysql_select_db("jobs",$con))
                                            	die("No Database Selected");
                                            $result = mysql_query("SELECT DISTINCT country FROM jobs.employer;");
                                            while($row_country = mysql_fetch_array($result))
                                            {
                                                $country = $row_country["country"];
                                                echo "<b style='text-transform: uppercase'>".$country."</b><br />";
                                                
                                                $res = mysql_query("SELECT DISTINCT state FROM jobs.employer WHERE country='".$country."';");
                                                
                                                while($row_st = mysql_fetch_array($res))
                                                {
                                                    echo "<a href='display.php?state=".$row_st["state"]."'>".$row_st["state"]."</a><br />";
                                                }
