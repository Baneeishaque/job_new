...
$result=null;
$row=null;
$result=mysql_query("SELECT otp FROM jobs.employer where email='".$em."' ;");
...
if($row==null)
{
        ...
        if($ot==$otp)
        {
            ...
            mysql_query("UPDATE `employer` SET status='verified' WHERE email='".$em."'");
            echo "<br /><div class='hero-parallax'>

					<div class='hero-text'>

						<h1>You Are<br /><span>Verified</span></h1>
                        <br /><br /><br /><br /><br /><br />";
            $refresh="http://localhost/job_new/index.php";
            echo "<meta http-equiv='refresh' content='5;URL=".$refresh."' />";
        }
 else {
     
     echo "<div class='hero-parallax'>

					<div class='hero-text'>

						<h1>Invalid OTP<br /><span>Please Request Aother One</span></h1>
                        <br />";
     echo "<input type='button' value='Resend' class='formsbtn'/><br /><br /><br /><br /><br />";
 }
				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="column-2">
							...
							<h2>Employer Verification <span class="line"><span></span></span></h2>
