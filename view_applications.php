				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="column-2">
							...
							<h2>Applied Employees<span class="line"><span></span></span></h2>
...
$result_employee_name = mysql_query("SELECT iduser,name FROM jobs.employee WHERE jobs_applied REGEXP '[[:<:]]".$idemployer."[[:>:]]';");

while($row_employee_name = mysql_fetch_array($result_employee_name))
{
    $iduser = $row_employee_name["iduser"];
    echo "<a href='display_employee.php?iduser=".$iduser."' style='text-transform: uppercase'>".$row_employee_name["name"]."<a><br />";
}
